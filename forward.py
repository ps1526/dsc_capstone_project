...
def format_query(log_dict, dataset_name, prompt):
    ...
    if dataset_name == "ambiginst" or dataset_name == "arc_chall" or dataset_name == "arc_easy" or dataset_name == "openbookqa" or dataset_name == "squad_v2" or dataset_name == "trivia_qa" or dataset_name == "truthful_qa":
