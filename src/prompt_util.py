def load_system_prompt(dataset_name):
    ...
    if dataset_name == 'ambigqa':
        return ''
    elif dataset_name == "ambiginst" or dataset_name == "arc_chall" or dataset_name == "arc_easy" or dataset_name == "openbookqa" or dataset_name == "squad_v2" or dataset_name == "trivia_qa" or dataset_name == "truthful_qa":
        return ""
