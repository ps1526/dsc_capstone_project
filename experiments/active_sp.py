...
def main(args):
    ...
    for case in data:
        ...
        baseline_conf = evaluate_confidence(context, args.model, task="sp")
        ...
        for q in candidate_questions:
            ...
            # Get NPC answer
            simulated_answer = evaluate_confidence(sim_answer_case, args.model, task="sp")  # Reuse function
            ...
            conf = evaluate_confidence(augmented_case, args.model, task="sp")
